...
public class CodeCharController : MonoBehaviour
{
    ...
    const string kIdleAnim = "Player_idle";
    const string kRunAnim = "Player_run";
    const string kJumpStartAnim = "Player_jump";
    const string kJumpFallAnim = "Player_fall";
    const string kJumpLandAnim = "Player_land";
    ...
    void Update()
    {
        ...
        jumpJustPressed = Input.GetKeyDown("space");
        jumpHeld = Input.GetKey("space");
